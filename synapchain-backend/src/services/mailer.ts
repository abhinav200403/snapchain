...
export async function sendWelcomeEmail(opts: {
    ...
    <body>
      <div class="card">
        <div class="logo">
          ...
          <span class="logo-name">NeuroChain AI</span>
        </div>

        <h1>Welcome to ${opts.companyName ?? 'NeuroChain AI'} 👋</h1>
        ...
        <div class="footer">
          © ${new Date().getFullYear()} NeuroChain AI · This is an automated message, do not reply.
        </div>
      </div>
    </body>
    </html>
  ...
  await transporter.sendMail({
    from: `"NeuroChain AI" <${process.env.SMTP_USER}>`,
    to: opts.to,
    subject: `Your NeuroChain AI account is ready`,
    html,
  });
}
